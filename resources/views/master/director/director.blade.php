            ...
            <div class="modal-body">
                    <div class="mx-auto p-5 my-model text-white">
                     ...
                     <div class="row mb-3">
                        ...
                        <div class="col pe-0 pe-xl-5">
                            <input name="email" id="email" class="w-100 px-2 py-1 @error('email') is-invalid @enderror"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col pe-0 pe-xl-5">
                            <input name="contact_nos[]" id="mob0" class="w-100 px-2 py-1 @error('contact_nos.0') is-invalid @enderror"
                                type="number" placeholder="Mobile No." value="{{ old('contact_nos.0') }}">
                    ...
                    <div class="row row-cols-1 row-cols-xl-4 g-1">
                        ...
                        <div class="col mb-3 mb-xl-0 ms-0 ms-xl-3">
                            <input id="fromDate" name="from_date" class="w-100 px-2 py-1 @error('from_date') is-invalid @enderror" 
                        ...
                        <div class="col ms-0 ms-xl-3">
                            <input id="toDate" name="to_date" class="w-100 px-2 py-1 @error('to_date') is-invalid @enderror"
