                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input name="ledger_no" id="ledgerNo" type="text"
                                        ...
                                        value="{{ old('ledger_no') }}" placeholder="Ledger No.">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input id="name" name="name" type="text"
                                        ...
                                        value="{{ old('name') }}" placeholder="Ledger Name">
                            ...
                            <div class="col-md-3">
                                <div class="form-floating">
                                    <input name="open_balance" id="openBalance" type="number"
                                        ...
                                        value="{{ old('open_balance') }}" placeholder="Open Balance">
                            ...
                            <div class="col-md-3">
                                <div class="form-floating">
                                    <input name="min_balance" id="minBalance" type="number"
                                        ...
                                        value="{{ old('min_balance') }}" placeholder="Min. Balance">
                            ...
                            <div class="col-md-3">
                                <div class="form-floating">
                                    <input name="open_date" id="openDate" type="date"
                                        ...
                                        value="{{ old('open_date') }}" placeholder="Open Date">
                            ...
                            <div class="col-md-3">
                                <div class="form-floating">
                                    <select name="item_of" id="itemOf"
                                        class="form-select @error('item_of') is-invalid @enderror">
                            ...
                            <div class="col-md-3">
                                <div class="form-floating">
                                    <select name="send_sms" id="sendSMS"
                                        class="form-select @error('send_sms') is-invalid @enderror">
