                ...
                <div class="modal-body">
                    ...
                    <div class="mx-auto p-5 my-model text-white">
                        <div class="row ">
                            ...
                            <div class="col-4">
                                <input name="ledger_no" id="ledgerNo"
                                    class="px-2 py-1 @error('ledger_no') is-invalid @enderror"
                                    value="{{ old('ledger_no') }}" type="text" placeholder="Ledger">
                                @error('ledger_no')
                            ...
                            <div class="col-4">
                                <input id="name" name="name" class="px-2 py-1 @error('name') is-invalid @enderror"
                                    type="text" value="{{ old('name') }}" placeholder="Ledger Name">
                                @error('name')
                                <div class="invalid-feedback">{{$message}}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-4">
                                <select name="parent_ledger_id" id="parentLedger" value="{{ old('ledger_no') }}"
                                    placeholder="Parent Ledger"
                                    class="w-100 px-2 py-1 @error('ledger_no') is-invalid @enderror">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-2">
                                <input name="balance" id="balance"
                                    class="w-100 px-2 py-1 @error('balance') is-invalid @enderror"
                            ...
                            <div class="col-2">
                                <select name="balance_type" id="balanceType"
                                    class="w-100 px-2 py-1 @error('balance_type') is-invalid @enderror">
                            ...
                            <div class="col-2">
                                <input name="penal_rate" id="penalRate"
                                    class="w-100 px-2 py-1 @error('penal_rate') is-invalid @enderror"
                                    value="{{ old('penal_rate') }}" type="number" placeholder="Penal Rate">
                                @error('penal_rate')
                                <div class="invalid-feedback">{{$message}}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-2">
                                <input name="open_balance" id="openBalance"
                                    class="w-100 px-2 py-1 @error('open_balance') is-invalid @enderror"
                            ...
                            <div class="col-2">
                                <select name="open_balance_type" id="openBalanceType"
                                    class="w-100 px-2 py-1 @error('open_balance_type') is-invalid @enderror">
                                    <option value="Credit">Credit</option>
                                    <option value="Debit">Debit</option>
                                </select>
                            ...
                            <div class="col-2">
                                <input name="interest_rate" id="interestRate"
                                    class="w-100 px-2 py-1 @error('interest_rate') is-invalid @enderror"
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-2">
                                <input name="min_balance" id="minBalance"
                                    class="w-100 px-2 py-1 @error('min_balance') is-invalid @enderror"
                                    value="{{ old('min_balance') }}" type="number" placeholder="Min. Balance">
                                @error('min_balance')
                                <div class="invalid-feedback">{{$message}}</div>
                                @enderror
                            </div>
                            <div class="col-2">
                                <select name="min_balance_type" id="minBalanceType"
                                    class="w-100 px-2 py-1 @error('min_balance_type') is-invalid @enderror">
                                    <option value="Credit">Credit</option>
                                    <option value="Debit">Debit</option>
                                </select>
                            ...
                            <div class="col-3">
                                <select name="interest_type" id="interestType"
                                    class="w-100 px-2 py-1 @error('interest_type') is-invalid @enderror">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-2">
                                <input name="open_date" id="openDate"
                                    class="w-100 px-2 py-1 @error('open_date') is-invalid @enderror"
                                    value="{{ old('open_date') }}" type="date" placeholder="Open Date">
                                @error('open_date')
                                <div class="invalid-feedback">{{$message}}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-2">
                                <select name="gl_type" id="glType"
                                    class="w-100 px-2 py-1 @error('gl_type') is-invalid @enderror">
                            ...
                            <div class="col-2">
                                <input type="number" name="cd_ratio" id="cdRatio"
                                    class="w-100 px-2 py-1 @error('cd_ratio') is-invalid @enderror">
                                @error('cd_ratio')
                                <div class="invalid-feedback">{{$message}}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-2">
                                <select name="add_interest_to_balance" id="addInterestToBalance"
                                    class="w-100 px-2 py-1 @error('add_interest_to_balance') is-invalid @enderror">
                            ...
                            <div class="col-2">
                                <select name="item_of" id="itemOf"
                                    class="w-100 px-2 py-1 @error('item_of') is-invalid @enderror">
                            ...
                            <div class="col-2">
                                <select name="group" id="group"
                                    class="w-100 px-2 py-1 @error('group') is-invalid @enderror">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-2">
                                <select name="subsidiary" id="subsidiary"
                                    class="w-100 px-2 py-1 @error('subsidiary') is-invalid @enderror">
                                    <option value="1">Yes</option>
                                    <option selected value="0">No</option>
                                </select>
                                @error('subsidiary')
                            ...
                            <div class="col-2">
                                <select name="send_sms" id="sendSMS"
                                    class="w-100 px-2 py-1 @error('send_sms') is-invalid @enderror">
                                    <option value="1">Yes</option>
                            ...
                            <div class="col-3">
                                <select name="type" id="type"
                                    class="w-100 px-2 py-1 @error('type') is-invalid @enderror">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-2">
                                <select name="demand" id="demand"
                                    class="w-100 px-2 py-1 @error('demand') is-invalid @enderror">
                                    <option value="1">Yes</option>
                                    <option value="0" selected>No</option>
                                </select>
                                @error('demand')
