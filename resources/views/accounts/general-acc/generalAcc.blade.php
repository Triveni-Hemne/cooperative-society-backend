                    ...
                    <div class="mx-auto p-5 my-model text-white">
                        <div class="row mb-2">
                            ...
                            <div class="col pe-0 pe-xl-5">
                                ...
                                <select id="ledgerId" name="ledger_id"
                                    class="w-100 px-2 py-1 @error('ledger_id') is-invalid @enderror">
                                ...
                                <small class="text-danger">⚠️ You must add general ledgers before submitting the
                                    form.</small>
                                @endif
                            </div>
                            @endisset
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-4 pe-0 pe-xl-5">
                                <input name="account_no" id="accountNo"
                                    class="w-100 px-2 py-1 @error('account_no') is-invalid @enderror"
                                    value="{{ old('account_no') }}" type="text" placeholder="Account No.">
                                @error('account_no')
                                <div class="invalid-feedback">{{$message}}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col pe-0 pe-xl-5">
                                <input name="account_name" id="accountName"
                                    class="w-100 px-2 py-1 @error('account_name') is-invalid @enderror" type="text"
                            ...
                            <div class="col pe-0 pe-xl-5">
                                <input name="name" id="name" class="w-100 px-2 py-1 @error('name') is-invalid @enderror"
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-4 pe-0 pe-xl-5">
                                <select id="accountType" name="account_type"
                                    class="w-100 px-2 py-1 @error('account_type') is-invalid @enderror">
                                    <option value="select">------ Select Type ------</option>
                                    <option value="Deposit" {{ old('account_type') == 'Deposit' ? 'selected' : '' }}>
                                        Deposit</option>
                                    ...
                                    <option value="Investment"
                                        {{ old('account_type') == 'Investment' ? 'selected' : '' }}>Investment</option>
                                </select>
                                @error('account_type')
                                <div class="invalid-feedback">{{$message}}</div>
                                @enderror
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col pe-0 pe-xl-5">
                                <input name="start_date" id="startDate"
                                    class="w-100 px-2 py-1 @error('start_date') is-invalid @enderror"
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col pe-0 pe-xl-5">
                                ...
                                <select id="agentId" name="agent_id" class="w-100 px-2 py-1 @error('agent_id') value="
                                    {{ old('agent_id') }}" is-invalid @enderror">
                            ...
                            @endisset
                            <div class="col">
                                <input type="checkbox" {{ old('closing_flag') ? 'checked' : '' }} name="closing_flag"
                                    class="@error('closing_flag') is-invalid @enderror" value="1" id="closingFlag">
                            ...
                            <div class="col pe-0 pe-xl-5">
                                <input type="checkbox" {{ old('add_to_demand') ? 'checked' : '' }} name="add_to_demand"
                                    class="@error('add_to_demand') is-invalid @enderror" value="1" id="addToDemand">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col pe-0 pe-xl-5">
                                <select id="installmentType" name="installment_type"
                                    class="w-100 px-2 py-1 @error('installment_type') is-invalid @enderror">
                                    <option value="select">------ Select Installment Type ------</option>
                                    <option value="Monthly"
                                        {{ old('installment_type') == 'Monthly' ? 'selected' : '' }}>Monthly</option>
                                    <option value="Quarterly"
                                        {{ old('installment_type') == 'Quarterly' ? 'selected' : '' }}>Quaterky</option>
                            ...
                            <div class="col pe-0 pe-xl-5">
                                <input name="installment_amount" id="installmentAmount"
                                    class="w-100 px-2 py-1 @error('installment_amount') is-invalid @enderror"
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col pe-0 pe-xl-5">
                                <input name="total_installments_paid" id="totalInstallmentsPaid"
                                    class="w-100 px-2 py-1 @error('total_installments_paid') is-invalid @enderror"
                            ...
                            <div class="col pe-0 pe-xl-5">
                                <input name="closing_date" id="closingDate"
                                    class="w-100 px-2 py-1 @error('closing_date') is-invalid @enderror"
