<div class="modal fade" id="loanInstallmentModal" tabindex="-1" aria-labelledby="loanInstallmentModalLabel"
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form method="POST" action="{{route('installment-transactions.store')}}" id="loanInstallmentModalForm">
                    ...
                    <div class="mx-auto p-5 my-model text-white">
                        <div class="row mb-3">
                            ...
                            <div class="col pe-0 pe-xl-5">
                                    ...
                                    <select id="loanId" name="loan_id" class="w-100 px-2 py-1 @error('loan_id') is-invalid @enderror">
                         ...
                         <div class="row mb-2">
                            ...
                            <div class="col-4 pe-0 pe-xl-5">
                                <input name="installment_type" id="installmentType" class="w-100 px-2 py-1 @error('installment_type') is-invalid @enderror" value="{{ old('installment_type') }}" type="number" placeholder="Installment Type">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-4 pe-0 pe-xl-5">
                                <input name="installment_amount" id="installmentAmount" class="w-100 px-2 py-1 @error('installment_amount') is-invalid @enderror" value="{{ old('installment_amount') }}" type="date" placeholder="Installment Amount">
                            ...
                            <div class="col pe-0 pe-xl-5">
                               <input name="installment_with_interest" id="interestEarned" class="w-100 px-2 py-1 @error('installment_with_interest') is-invalid @enderror" value="{{ old('installment_with_interest') }}" type="text" placeholder="Installment With Interest">
