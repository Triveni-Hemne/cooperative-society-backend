                    ...
                    <div class="mx-auto p-5 my-model text-white">
                        ...
                        @endif
                            <div class="row mb-2">
                                ...
                                <div class="col pe-0 pe-xl-5">
                                    <input name="closing_cash_balance" id="ClosingCashBalance" class="w-100 px-2 py-1 @error('closing_cash_balance') is-invalid @enderror" value="{{ old('closing_cash_balance') }}" type="number" placeholder="Closing Cash Balance" required>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col pe-0 pe-xl-5">
                                    <input name="total_receipts" id="ClosingCashBalance" class="w-100 px-2 py-1 @error('total_receipts') is-invalid @enderror" value="{{ old('total_receipts') }}" type="number" placeholder="Total Receipts" required>
                                ...
                                <div class="col pe-0 pe-xl-5">
                                    <input name="total_payments" id="TotalPayments" class="w-100 px-2 py-1 @error('total_payments') is-invalid @enderror" value="{{ old('total_payments') }}" type="number" placeholder="Total Payments" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col pe-0 pe-xl-5">
                                    <input name="system_closing_balance" id="SystemClosingBalance" class="w-100 px-2 py-1 @error('system_closing_balance') is-invalid @enderror" value="{{ old('system_closing_balance') }}" type="number" placeholder="System Closing Balance" required>
                                ...
                                <div class="col pe-0 pe-xl-5">
                                    <input name="difference_amount" id="DifferenceAmount" class="w-100 px-2 py-1 @error('difference_amount') is-invalid @enderror" value="{{ old('difference_amount') }}" type="number" placeholder="Difference Amount" required>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col pe-0 pe-xl-5">
                                    <input name="is_day_closed" id="IsDayClosed" class="w-100 px-2 py-1 @error('is_day_closed') is-invalid @enderror" value="{{ old('is_day_closed') }}" type="text" placeholder="Is Day Closed" required>
                                    @error('is_day_closed')
                                        <div class="invalid-feedback">{{$message}}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col pe-0 pe-xl-5">
                                    <input name="opening_cash" id="openingCash" class="w-100 px-2 py-1 @error('opening_cash') is-invalid @enderror" value="{{ old('opening_cash') }}" type="number"
                                        placeholder="Opening Cash" required>
                                        @error('opening_cash')
                                        <div class="invalid-feedback">{{$message}}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col pe-0 pe-xl-5">
                                    <input name="total_credit_rs" id="totalCreditRs" class="w-100 px-2 py-1 @error('total_credit_rs') is-invalid @enderror" value="{{ old('total_credit_rs') }}" type="text"
                                        placeholder="Total Credit RS" required>
                                ...
                                <div class="col pe-0 pe-xl-5">
                                    <input name="total_credit_chalans" id="totalCreditChalans" class="w-100 px-2 py-1 @error('total_credit_chalans') is-invalid @enderror" value="{{ old('total_credit_chalans') }}" type="number"
                                        placeholder="Total Credit Challan" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col pe-0 pe-xl-5">
                                <input name="total_debit_rs" id="totalDebitRs" class="w-100 px-2 py-1 @error('total_debit_rs') is-invalid @enderror" value="{{ old('total_debit_rs') }}" type="text"
                                    placeholder="Total Debit RS" required>
                            ...
                            <div class="col pe-0 pe-xl-5">
                                <input name="total_debit_challans" id="totalDebitChallans" class="w-100 px-2 py-1 @error('total_debit_challans') is-invalid @enderror" value="{{ old('total_debit_challans') }}" type="number"
                                    placeholder="Total Debit Challan" required>
