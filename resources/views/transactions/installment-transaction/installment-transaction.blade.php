<div class="modal fade" id="installmentTransactionModal" tabindex="-1"
    aria-labelledby="installmentTransactionModalLabel" aria-hidden="true">
                    ...
                    <div class="p-4 bg-white rounded shadow-sm">
                        ...
                        <div class="form-floating mb-3">
                            <input name="amount_paid" id="amountPaid" type="number"
                                ...
                                placeholder="Amount Paid" value="{{ old('amount_paid') }}" required>
                        ...
                        <div class="form-floating mb-3">
                            <input name="payment_date" id="paymentDate" type="date"
                                ...
                                placeholder="Payment Date" value="{{ old('payment_date') }}" required>
